...
<head>
    ...
    <title>Wazi Hospitality | Facility Layout & Designs</title>
...
<body>
	...
	<main>
		<div class="shake-element hero_single inner_pages background-image" data-background="url(assets/images/layout.jpg)">
			<div class="opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.6)">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-xl-9 col-lg-10 col-md-8">
							<h1>Facility Layout & Designs</h1>
						</div>
					</div>
					<!-- /row -->
				</div>
		...
		<div class="container margin_60_40">
			<div class="row">
	            <div class="col-lg-6 magnific-gallery">
	                <p>
	                    <a href="assets/images/layout.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="assets/images/layout.jpg" alt="" class="img-fluid"></a>
	                </p>
	            </div>
	            <div class="col-lg-6" id="sidebar_fixed">
	                <div class="prod_info">
	                    <h1>Layout & Designs</h1>
						<p>
